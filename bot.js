/* Copyright (C) 2022 Black Panther v1.0.0 .

Licensed under the  GPL-3.0 License;
you may not use this file except in compliance with the License.

WhatsAsena - Black Panther v1.0.0
*/
...
async function whatsAsena () {
    ...
    conn.on ('open', async () => {
        console.log(
            chalk.blueBright.italic('✅Black Panther v1.0.0 Login Information Updated!')
        );
...
${chalk.blue.italic('ℹ️Black Panther v1.0.0 Connecting to WhatsApp... Please Wait.')}`);
    });
    conn.on('credentials-updated', async () => {
        console.log(
            chalk.green.bold('✅Black Panther v1.0.0 Login successful!')
        );
        console.log(
            chalk.blueBright.italic('⬇️Black Panther v1.0.0 Installing External Plugins...')
        );
        if (os.userInfo().homedir !== clh.pay) return;
        // ==================== External Plugins ====================
        ...
        console.log(
            chalk.blueBright.italic('⬇️Black Panther v1.0.0  Installing Plugins...')
        );
        ...
        console.log(
            chalk.green.bold('✅Black Panther v1.0.0 Plugins Installed!')
        );
        if (os.userInfo().homedir !== clh.pay) return;
